...
class BuscadorNoticias:
    ...
    def buscar_portais_juridicos(self, termo):
        """Busca em portais jurídicos brasileiros - REMOVIDOS STF e CONJUR"""
        noticias = []
        portais = [
            {
                "nome": "Jusbrasil", 
    ...
    def _gerar_noticias_simuladas(self, termo):
        ...
        for i in range(3):
            ...
            noticias.append({
                ...
                "fonte": random.choice(["Portal Jurídico", "Jusbrasil", "Migalhas"]),
    ...
    def buscar_noticias(self, termo):
        ...
        # Busca em todas as fontes (REMOVIDOS STF e CONJUR)
        ...
        for noticia in noticias:
            if noticia['titulo'] not in titulos_vistos:
                ...
                if fonte == "Jusbrasil" and "jusbrasil.com.br" not in url:
                    ...
                    noticia['url'] = f"https://g1.globo.com/busca/?q={urllib.parse.quote(termo)}+direito"
